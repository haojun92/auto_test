...
class Generator(object):
    def __init__(self):
        self._dll_path = "E0X_FCM.dll"

        self.dll = ctypes.windll.LoadLibrary("./lib/E0X_FCM.dll")

        self.dll.GenerateKeyEx.argtypes = [
        ...
        self.dll.GenerateKeyEx.restype = ctypes.c_int  # VKeyGenResultExOpt
    ...
    def request_key(self, seed: str, security_level: int, max_key_array_size: int = 16, variant=b"",option =b""):
        ...
        result: VKeyGenResultExOpt = self.dll.GenerateKeyEx(
